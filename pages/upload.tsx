      ...
      <div className="w-[80%] bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
        ...
        <div className="flex flex-col gap-3 pb-10 ">
          ...
          <div className="flex gap-6 mt-10">
            <button
              type="button"
              className="border-gray-300 border-2 text-mt font-medium p-2 rounded w-28 lg:w-44 outline-none"
              onClick={() => {}}
            >
              Discard
            </button>
            <button
              type="button"
              className="bg-[#f51997] text-white text-mt font-medium p-2 rounded w-28 lg:w-44 outline-none"
              onClick={handlePost}
            >
              Post
            </button>
